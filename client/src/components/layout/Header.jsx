...
export default function Header() {
    ...
    return (
        <header className="h-14 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between px-6 transition-colors">
            <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-800 dark:text-white font-semibold">
                        <span className="text-blue-600 dark:text-blue-400">Inventory</span> Management System
                    </span>
                </div>
            </div>
